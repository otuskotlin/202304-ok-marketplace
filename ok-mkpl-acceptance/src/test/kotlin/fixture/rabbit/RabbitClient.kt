package ru.otus.otuskotlin.marketplace.blackbox.fixture.rabbit
 ...
 * Запросы уходят в $version-queue-in, а ответы читаются из $version-queue-out
 */
class RabbitClient(
    ...
    override suspend fun sendAndReceive(version: String, path: String, request: String): String {
        ...
        channel.basicPublish("", "$version-queue-in", null, request.toByteArray())
